...
//----------------------------------------------------------------------------------------
  moveRocksInterval = setInterval(() => {
    ...
    const moveBullet = setInterval(() => {
        ...
        const bullet =document.getElementByIdByClass("bullets")
        ...
        for (const bullet1 of bullet){
            for (const rock of rocks ){
                const rockBound = rock.getBoundingClientRect()
                const bulletBound = bullet1.getBoundingClientRect();
                //rock && bullet(rock + bullet)
                if (
                    ...
                    bulletBound.bottom <= rockBound.bottom) {
                        ...
                        rock.parentElement.removeChild(rock);
                        bullet1.parentElement.removeChild(bullet1);
        ...
        for (const bullet1 of bullet){
            //bullet out   (bullet)
            const bulletBottom = parseInt(window.getComputedStyle(bullet1).getPropertyValue("bottom"));
